...
/* S-Space corpus writer is very simple because S-Space wants the text, so no
 * vectorization required, and it's happy to accept the input in sequence.
 * We'll just do a bit of preprocessing and send the string back.
 */

public class CorpusWriterSspace {

	private static List<String> DEFAULT_STOP_WORDS = 
	...
	public static String prepare(String instr) {
