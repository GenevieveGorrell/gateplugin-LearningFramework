...
public class FeatureExtractor {
  ...
  static final Logger logger = Logger.getLogger(FeatureExtractor.class.getCanonicalName());
  ...
  /**
   * In the case of named entity recognition, we construct the class based on the instance's
   * position relative to the class annotation type. If it occurs at the beginning of the class
