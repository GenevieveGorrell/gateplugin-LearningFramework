...
public class CorpusWriterMallet extends CorpusWriter {
  ...
  /**
   * Builds a Mallet instance based on the config file and returns it. The instance is unpiped. It's
   * just a bunch of strings that needs more work later on before it can be used as input.
   */
  ...
  /**
   * Builds a Mallet instance based on the config file and returns it. The instance is unpiped. It's
   * just a bunch of strings that needs more work later on before it can be used as input. Class is
   * included; this method is used to prepare training data.
   */
  ...
  /**
   * Builds an instance as a string based on the config file and returns it. Untested since adding
   * ngrams. Can't handle numeric classes.
   */
  ...
  /**
   * Create and return a set of Mallet instances from the GATE data saved to file. Should probably
   * improve this at some point to have a more unique separator, but it isn't currently being used
   * anywhere so it's low priority.
   */
