...
public abstract class Engine {
  ...
  /**
   * Store a copy of the configuration file used at training time with the saved model. This means
   * that if the user changes their configuration file, it won't stuff up their ability to use their
   * saved model.
   *
   * @param conf
   */
  ...
  /**
   * Use the info file to correctly restore the learner from the saved model directory.
   *
